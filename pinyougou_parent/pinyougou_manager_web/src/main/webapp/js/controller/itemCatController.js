...
app.controller('itemCatController', function ($scope, itemCatService,typeTemplateService) {
    ...
    $scope.entity1 = null;    //一级分类对象 显示在面包屑上
    $scope.entity2 = null;    //二级分类对象 显示在面包屑上
    ...
    $scope.save = function () {
        ...
        // $scope.entity.parentId=1;    //向对象中追加新属性 非标准写法
        $scope.entity ['parentId'] = $scope.parentId;    //向对象中追加新属性 标准写法
