...
public class OrderItemController {
	...
	public PageResult findPage(@PathVariable("pageNum") int pageNum, @PathVariable("pageSize") int pageSize){
		return orderItemService.findPage(pageNum, pageSize);
	}
	...
	public TbOrderItem findOne(@PathVariable("id") Long id){
	...
	public PageResult search(@RequestBody TbOrderItem orderItem, @PathVariable("pageNum") int pageNum, @PathVariable("pageSize") int pageSize ){
		return orderItemService.findPage(orderItem, pageNum, pageSize);		
	}
