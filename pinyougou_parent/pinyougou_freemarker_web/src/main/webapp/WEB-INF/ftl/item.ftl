...
<head>
    ...
    <script type="text/javascript">
        ...
        var itemList = [
            /* 循环goods.itemList,得到每一个item的id和spec */
...
<div class="py-container">
    <div id="item">
        <div class="crumb-wrap">
            <ul class="sui-breadcrumb"><#-- 三级分类及商品名称 -->
                <li>
            ...
            <#-- ?eval : 将json字符串转换为对象-->
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
							<#if (images?size>0)>
                                <span class="jqzoom"><img style="height: 400px;width: 400px" jqimg="${images[0].url}"
                                                          src="${images[0].url}"/></span>
                            </#if>
                    </div>
                    <!--下方的缩略图-->
                ...
                <div class="clearfix choose">
                    ...
                    <div id="specification" class="summary-wrap clearfix">
							<#list specificationItems as spec >
                                ...
                                <#--class="selected"-->     <#-- Controller.js 有 ifSelectd 方法 -->
								 <dd><a href="javascript:;"
                                        ng-click="changSpec('${spec.attributeName}','${attr}')"
                                        class="{{ifSelectd('${spec.attributeName}','${attr}')?'selected':''}}">
                                     ${attr}
